...
import { totalTimeStr } from "../utils/timeUtils";

const screenWidth = Dimensions.get("window").width;

export default function TodayScreenTime() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (!granted) return;
      const data = await AppBlockingService.getUsageStats(1); // Fetch today's usage
      setUsage(data);
